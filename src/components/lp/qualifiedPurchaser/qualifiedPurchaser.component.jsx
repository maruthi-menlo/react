...
class QualifiedPurchaserComponent extends Component {
    ...
    updateInvestorInputFields(data) {
        if(this.state.areYouQualifiedPurchaser === false) {
            this.setState({
        ...
        return (
            <div className="qualifiedPurchaser width100">
                <div className="form-grid formGridDivMargin min-height-400">
                        <div className="title">Qualified Purchaser (3/7)</div>
                        <Row className="step1Form-row">
                            <Col xs={12} md={12}>
                                {/* <label className="form-label width100">Are you an “qualified purchaser” within the meaning of Section 2(a)(51) under the Companies Act, as amended?</label> */}
                                <label className="form-label width100" hidden={this.state.investorType !== 'Individual'}>Are you  an &nbsp;
                                <LinkWithTooltip tooltip={<span>"
                                    "You are an “qualified purchaser” if you own investments that are valued at not less than USD $5,000,000.  If you propose to acquire the interest in the investment fund as to which you propose to subscribe in a joint capacity with your spouse, such as community property or a similar shared interest, then you may include in this determination investments owned by your spouse.
                                    Investments data:
                                    ...
                                    (5) Financial contracts within the meaning of Section 3(c)(2)(B)(ii) of the Companies Act, which are held for investment purposes.
                                    ...
                                    Valued data:
                                    “Valued” shall mean either the fair market value or cost of Investments net of the amount of any outstanding indebtedness incurred to acquire such Investments."</span>} id="tooltip-1">
                                    <span className="helpWord"><strong>“qualified purchaser”</strong></span>
                                ...
                                <LinkWithTooltip tooltip={<span>"
                                    ""If any one of the four options below apply, the Entity is considered a “qualified purchaser” and if none of the four options below apply, the Entity is not a “qualified purchaser”:
                        ...
                        <Row className="step1Form-row" hidden={!this.state.showQualifiedClient}>
                            <Col xs={12} md={12}>
                                <label className="form-label width100" hidden={this.state.investorType !== 'Individual'}>Are you a “qualified client” within the meaning of Rule 205-3 under the Advisers Act?</label>
                                <label className="form-label width100" hidden={this.state.investorType !== 'LLC'}>Is your Entity considered a &nbsp;
                                <LinkWithTooltip tooltip={<span>"
                                    ...
                                    "</span>} id="tooltip-1">
                                    <span className="helpWord"><strong>“qualified client”</strong></span>
                                </LinkWithTooltip> &nbsp; within the meaning of Rule 205-3 under the Advisers Act? &nbsp;
                                </label>
                        ...
                        <Row className="step1Form-row" hidden={this.state.investorType !== 'revocableTrust'}>
                            <Col xs={12} md={12}>
                                ...
                                <LinkWithTooltip tooltip={<span>"
                                    "If any one of the four options below apply, the Trust is considered a “qualified purchaser” and if none of the four options below apply, the Trust is not a “qualified purchaser”:
                        ...
                        <Row className="step1Form-row" hidden={!this.state.showQualifiedClient || this.state.investorType !== 'revocableTrust'}>
                            <Col xs={12} md={12}>
                                ...
                                <LinkWithTooltip tooltip="" href="#" id="tooltip-1">
                                    <span className="helpWord"><strong>Advisers Act?</strong></span>
                                </LinkWithTooltip>
                                </label>
